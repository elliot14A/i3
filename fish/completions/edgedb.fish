...
complete -c edgedb -n "__fish_edgedb_using_subcommand restore" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand configure; and not __fish_seen_subcommand_from insert reset set help" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from create" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from status" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from log" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from edit" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from upgrade-check" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from extract" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand migration; and __fish_seen_subcommand_from upgrade-format" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand database; and not __fish_seen_subcommand_from create drop wipe help" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand database; and __fish_seen_subcommand_from drop" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand database; and __fish_seen_subcommand_from wipe" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branching; and __fish_seen_subcommand_from drop" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branching; and __fish_seen_subcommand_from wipe" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branching; and __fish_seen_subcommand_from list" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branching; and __fish_seen_subcommand_from switch" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branching; and __fish_seen_subcommand_from rename" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand describe; and __fish_seen_subcommand_from schema" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from casts" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from databases" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from branches" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from indexes" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from modules" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from roles" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from scalars" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand list; and __fish_seen_subcommand_from types" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand query" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand query" -s L -l input-language -d 'Input language: edgeql, sql. Default is edgeql' -r -f -a "{edgeql\t'',sql\t''}"
...
complete -c edgedb -n "__fish_edgedb_using_subcommand ui" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from link" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from backup" -s I -l instance -d 'Instance to restore' -r -f
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from backup" -l non-interactive -d 'Do not ask questions'
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from backup" -s h -l help -d 'Print help'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from restore" -s I -l instance -d 'Instance to restore' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from restore" -s h -l help -d 'Print help'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from list-backups" -s I -l instance -d 'Instance to list backups for' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from list-backups" -s h -l help -d 'Print help'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from credentials" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from list-available" -l channel -d 'Specify the channel override (stable, testing, or nightly)' -r -f -a "{stable\t'',testing\t'',nightly\t''}"
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from list-available" -s h -l help -d 'Print help'
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from install" -s I -l instance -d 'Specify local instance name' -r -f
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from install" -s E -l extension -d 'Name of the extension to install' -r
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from install" -l channel -d 'Specify the channel override (stable, testing, or nightly)' -r -f -a "{stable\t'',testing\t'',nightly\t''}"
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from install" -s h -l help -d 'Print help'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and not __fish_seen_subcommand_from create switch list current rebase merge rename drop wipe help" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from switch" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from list" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from current" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from rebase" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from merge" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from rename" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from drop" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand branch; and __fish_seen_subcommand_from wipe" -s I -l instance -d 'Instance name (use edgedb instance list to list local, remote and EdgeDB Cloud instances available to you)' -r -f
